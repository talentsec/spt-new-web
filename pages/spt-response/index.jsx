...
const securityIncidentList = [
  ...
  },
  {
    button: '清理',
    title: '清理',
    text: '系统中存在的木马、webshell后门、恶意程序、挂马页面；清理异常系统服务与进程'
  },
  {
    button: '恢复',
    title: '恢复',
    text: '被篡改的系统配置，删除黑客创建的后门账号'
  },
  {
    button: '加固',
    title: '加固',
...
const applicationList = [
  ...
  },
  {
    img: appImg2,
    title: '敏感时期监控服务',
    text: '特殊时期，如元旦、春节等 节假日；两会、国庆等敏感时期；新系统和新功能上线、促销和商业活动等重要时期，螣龙安科可提供远程或驻场安全运维监控，防止黑客攻击'
  },
]
