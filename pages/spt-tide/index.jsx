...
import FunctionCard from '@/components/product/tide/FunctionCard.jsx'
import DeveloperCard from '@/components/product/tide/DeveloperCard.jsx'
import UserCard from '@/components/product/tide/UserCard.jsx'
import Problem from '@/components/product/tide/Problem'
      ...
      <div className='min-w-max'>
        <section className='w-screen sm:min-w-main-width relative'>
          ...
          <div className='absolute top-3/4 mx-auto px-auto w-full flex justify-center gap-6'>
            ...
            <Button size='large' shape="round" ghost onClick={() => window.open('https://shang.qq.com//email/stop/email_stop.html', '_blank')}>在线咨询</Button>
          </div>
        </section>
