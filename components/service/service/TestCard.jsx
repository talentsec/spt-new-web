...
export default function TestCard() {
  return (
    <div className='p-6 flex w-full items-center mb-20'>
      <section className='bg-black p-8 w-1/3 text-white h-60'>
      ...
      <section className='bg-gray-200 p-8 w-1/3 h-60'>
      ...
      <section className='bg-blue-700 px-8 py-14 h-80 text-white w-1/3'>
        <Image src={icon2} alt=''></Image>
        <section className='text-xl font-bold mt-7 mb-4'>
          白盒测试
        </section>
