  ...
  return (
    <section className='w-full sm:min-w-main-width relative'>
      ...
      <div className='block sm:hidden'>
        <Image src={phoneImg} alt='' layout='responsive'></Image>
      </div>
      ...
      <section className='absolute top-1/2 pt-2 w-full flex justify-center'>
        <Link href='/spt-contact'>
          <div className='-mt-1 sm:mt-0 px-36 sm:px-6 py-2 sm:py-3 bg-white rounded-3xl text-blue-700 cursor-pointer hover:scale-105'>
            立即联系我们
          </div>
